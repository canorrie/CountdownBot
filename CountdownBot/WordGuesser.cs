namespace CountdownBot
{
    public class WordGuesser
    {
        ...
        public static Dictionary<int, string> wordDictionary = new Dictionary<int, string>();

        public static Dictionary<int, string> ReadWords()
        {
            ...
            try
            {
                ...
                while (line != null)
                {
                    dict.Add(ParseString(line), line);
                    line = sr.ReadLine();
                }
                sr.Close();
            }
